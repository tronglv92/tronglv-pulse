...
/*
Package streampb is a reverse proxy.
...
var filter_StreamService_SubscribeLogs_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}

func request_StreamService_SubscribeLogs_0(ctx context.Context, marshaler runtime.Marshaler, client StreamServiceClient, req *http.Request, pathParams map[string]string) (StreamService_SubscribeLogsClient, runtime.ServerMetadata, error) {
	var (
		protoReq SubscribeLogsRequest
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_StreamService_SubscribeLogs_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	stream, err := client.SubscribeLogs(ctx, &protoReq)
	if err != nil {
...
func RegisterStreamServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server StreamServiceServer) error {
	mux.Handle(http.MethodGet, pattern_StreamService_SubscribeLogs_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterStreamServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client StreamServiceClient) error {
	mux.Handle(http.MethodGet, pattern_StreamService_SubscribeLogs_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/pulse.stream.StreamService/SubscribeLogs", runtime.WithHTTPPathPattern("/v1/stream/logs"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_StreamService_SubscribeLogs_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
		}
		forward_StreamService_SubscribeLogs_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
	})
	return nil
}

var (
	pattern_StreamService_SubscribeLogs_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "stream", "logs"}, ""))
)

var (
	forward_StreamService_SubscribeLogs_0 = runtime.ForwardResponseStream
)
